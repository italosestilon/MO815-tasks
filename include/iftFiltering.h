...
//! swig(newobject, stable)
iftMatrix *iftMImageToFeatureMatrix(iftMImage *mimg, iftAdjRel *A);
//! swig(newobject, stable)
 ...
 */
//! swig(newobject, stable)
iftMImage *iftMMaxPooling(iftMImage *mimg, int poolSize, int stride);
 ...
 */
//! swig(newobject, stable)
iftMImageArray *iftMMaxPoolingArray(iftMImageArray *mimgArray, int poolSize, int stride);
 ...
 */
//! swig(newobject, stable)
iftMImage *iftMMinPooling(iftMImage *mimg, int poolSize, int stride);
 ...
 */
//! swig(newobject, stable)
iftMImageArray *iftMMinPoolingArray(iftMImageArray *mimgArray, int poolSize, int stride);
